...
SESSION_CONFIGS = [
   ...
   {
       'name': 'prototype',
       'display_name': "IAT for KBERI (IAT+설문. prototype) (작성중)",
       'num_demo_participants': 1,
       'app_sequence': ['iat', 'basic_survey'],
   },
   {
       'name': 'kberi_treatment_image_female',
       'display_name': "IAT for KBERI (여성이미지+IAT+설문. prototype) (작성중)",
       'num_demo_participants': 1,
   ...
   },
   {
       ...
       'display_name': "IAT for KBERI (남성이미지+IAT+설문. prototype) (작성중)",
       'num_demo_participants': 1,
   ...
   },
   {
       ...
       'display_name': "IAT for KBERI (꽃과나비이미지+IAT+설문. prototype) (작성중)",
       'num_demo_participants': 1,
   ...
   },
   {
       ...
       'display_name': "IAT for KBERI (인식개선퀴즈+IAT+설문. prototype) (작성중)",
       'num_demo_participants': 1,
       'app_sequence': ['no_treatment','iat', 'basic_survey'],
       'treatment': 'no_treatment',
   },
